...
import { Phone, Language, Email, RateReview } from '@material-ui/icons'
...
const Details = ({
    ...
    const handleClick = async () => {
        setBackdrop(true)
        let response = await axios.get(`https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/reverseGeocode?f=pjson&langCode=EN&location=${lmark.properties.longitude},${lmark.properties.latitude}`)
        setBackdrop(false)
        setOpen(!open)
